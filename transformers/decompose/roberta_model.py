...
class RobertaConfig(object):
    ...
    def __init__(self,
        ...
        Args:
            vocab_size_or_config_json_file: Vocabulary size of `inputs_ids` in `RobertaModel`.
    ...
    def from_dict(cls, json_object):
        """Constructs a `RobertaConfig` from a Python dictionary of parameters."""
        config = RobertaConfig(vocab_size_or_config_json_file=-1)
    ...
    def from_json_file(cls, json_file):
        """Constructs a `RobertaConfig` from a json file of parameters."""
...
class RobertaLayerNorm(nn.Module):
    ...
    def __repr__(self):
        return f"LayerNorm({self.gamma.shape[0],}, eps={self.variance_epsilon})"
...
class RobertaEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.LayerNorm = RobertaLayerNorm(config.hidden_size)
    ...
    def forward(self, input_ids, token_type_ids=None, past_key_values_length=0):
...
class PreTrainedRobertaModel(nn.Module):
    """ An abstract class to handle weights initialization and
        a simple interface for dowloading and loading pretrained models.
    """

    def __init__(self, config, *inputs, **kwargs):
        super(PreTrainedRobertaModel, self).__init__()
        if not isinstance(config, RobertaConfig):
            raise ValueError(
                "Parameter config in `{}(config)` should be an instance of class `RobertaConfig`. "
    ...
    def from_pretrained(cls, pretrained_model_name, cache_dir=None, *inputs, **kwargs):
        """
        Instantiate a PreTrainedRobertaModel from a pre-trained model file.
        ...
        Params:
            pretrained_model_name:
                - a path or url to a pretrained model archive containing:
                    ...
                    . `pytorch_model.bin` a PyTorch dump of a RobertaForPreTraining instance
            *inputs, **kwargs: additional input for the specific Roberta class
                (ex: num_labels for RobertaForSequenceClassification)
        """
...
class RobertaModel(PreTrainedRobertaModel):
    ...
    model = modeling.RobertaModel(config=config)
...
class RobertaForSequenceClassification(PreTrainedRobertaModel):
    ...
    config = RobertaConfig(vocab_size_or_config_json_file=32000, hidden_size=768,
        num_hidden_layers=12, num_attention_heads=12, intermediate_size=3072)
...
class RobertaForMaskedLM(PreTrainedRobertaModel):
...
def create_position_ids_from_input_ids(input_ids, padding_idx, past_key_values_length=0):
    """
    Note: Copied from https://github.com/huggingface/transformers/blob/48101cf8d127bbf22d751c7df118a6ce357e2e27/src/transformers/models/roberta/modeling_roberta.py#L1546
